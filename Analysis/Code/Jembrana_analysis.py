# -*- coding: utf-8 -*-
"""97236_Analysis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Mb8OGS8BSA3U64L3IjGim_Cg8Zz45xGE
"""
...
visualize_adfuller_results(df['RR'].values, 'RR', ax[3])
...
columns=['Tx','Tavg','RH_avg','RR', 'ss', 'ff_avg', 'TCI']
...
for i, column in enumerate(columns):
    ...
    ax[0,i].set_title('Decomposition {}'.format(column), fontsize=16)
...
fig, ax =plt.subplots(nrows=7,ncols=1,figsize=(10,8))
